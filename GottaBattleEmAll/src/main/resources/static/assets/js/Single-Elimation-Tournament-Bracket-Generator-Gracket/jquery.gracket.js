    ...
    var helpers = {
      build : {
        team : function(data, node){
          var html = [
            '<div class="col-xl-auto" style="padding: 0%;">',
            '<div class="table-responsive">',
            '<table class="table">',
            '<tbody>',
            '<tr>',
            '<th>',//Aggiungi a all'h3 con riferimento al link del player(devi farlo anche nel min.js)
            ...
            '</th>',
            '<th>',
            '<button class="btn btn-primary btn-sm">Res</button>', // Add your button here
            '</th>',
            '</tr>',
            '</tbody>',
            '</table>',
